                                        ...
                                        <div class="flex flex-wrap sm:mb-4 -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <select name="recruitment_status" id="recruitment_status" required
                                                        ...
                                                        <option value="">選択してください</option>
                                                        <option value="1"
                                                            {{ old('recruitment_status', $job->recruitment_status) == 1 ? 'selected' : '' }}>
                                                            募集中</option>
                                                        <option value="2"
                                                            {{ old('recruitment_status', $job->recruitment_status) == 2 ? 'selected' : '' }}>
                                                            募集終了</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <select name="public_status" id="public_status" required
                                                        class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block w-full">
                                                        <option value="">選択してください</option>
                                                        <option value="1"
                                                            {{ old('public_status', $job->public_status) == 1 ? 'selected' : '' }}>
                                                            公開</option>
                                                        <option value="2"
                                                            {{ old('public_status', $job->public_status) == 2 ? 'selected' : '' }}>
                                                            非公開</option>
                                                    </select>
                                                </div>
                                            </div>
