                        ...
                        <div class="flex flex-col justify-center md:flex-row">
                            <div class="lg:w-3/4 w-full mt-6 lg:mt-0">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                    <a href="{{ route('user.applicant.list') }}"
                                        class="block border border-gray-200 rounded p-4 hover:bg-gray-50">
                                        <p class="text-sm text-gray-500">応募履歴</p>
                                        <p class="text-3xl font-semibold text-gray-900">{{ $applicantsCount }}</p>
                                    </a>
                                    <a href="{{ route('user.applicant.accepted') }}"
                                        class="block border border-gray-200 rounded p-4 hover:bg-gray-50">
                                        <p class="text-sm text-gray-500">承諾済み求人</p>
                                        <p class="text-3xl font-semibold text-gray-900">{{ $acceptedCount }}</p>
                                    </a>
                                    <a href="{{ route('user.favorite.list') }}"
                                        class="block border border-gray-200 rounded p-4 hover:bg-gray-50">
                                        <p class="text-sm text-gray-500">お気に入り一覧</p>
                                        <p class="text-3xl font-semibold text-gray-900">{{ $favoritesCount }}</p>
                                    </a>
                                </div>
